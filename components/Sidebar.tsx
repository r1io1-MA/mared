...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen, isCollapsed, setIsCollapsed, activeView, setActiveView }) => {
  ...
  return (
    <>
      ...
      ></div>
      <aside className={`fixed top-0 right-0 h-full bg-slate-900 border-l border-slate-700 z-40 flex flex-col
        ...
        <div className="p-2 border-t border-slate-700">
             <button
                ...
                className="w-full hidden md:flex items-center gap-3 px-3 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white justify-center"
